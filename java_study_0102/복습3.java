...
public class 복습3 {
	...
	public static void main(String[] args) {
		 ...
		 * 키(key)와 값(value)의 쌍으로 데이터를 저장하는 "동적 배열"이라고 생각하면된다.
		 * 
		 * HashMap 키(key)로 값(value)을 검색하는 사전과 같다
		...
		*/
		...
		//사전에 단어와 뜻 추가하기
		dictionary.put("성심당", "대전광역시의 베이커리 전문점...");
		dictionary.put("엑스포", "1993년 세계 박람회는...");
		dictionary.put("대전 오월드", "오월드는 중구 사정동에 위치한...");
		...
		//특정 단어가 있는지 확인하기
		if(dictionary.containsKey("액스포")) {//사전에 엑스포가 있는지 확인
			System.out.println("사전에 있는 단어 입니다.");
		}else {
