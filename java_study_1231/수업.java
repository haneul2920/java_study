...
public class 수업 {
	...
	public static void main(String[] args) {
		// **제네릭과 컬렉션즈
		// 배열기초 -> 객체배열 -> 제네릭돠 컬렉션즈 (공부 순서)
		
		/*
		 * 제네릭과 컬렉션즈란?
		 * 배열처럼 데이터를 저장함
		 * 빠른 접근 속도와 '동적 크기' 조절이 가능한 장점들이 있다
		*/
		...
		/*
		 * 제네릭(<>) 특징
		 * 1. 클래스 타입만 넣을 수 있음. int 형을 담고 싶으면 int 에 클래스 타입인 Integer 를 작성		
		*/
		...
		*/
		...
		//삭제
		set.remove(20); //HashSet에 저장된 20값 삭제
